...
public class MazeGeneration : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (MazeGeneration.instance != null && MazeGeneration.instance != this)
            Destroy(this);
        else { MazeGeneration.instance = this; }
...
public class Cell
{
    ...
    public float HScore; //Distance estimated based on Heuristic = Cost
